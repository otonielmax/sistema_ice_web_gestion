                ...
                <div class="block-area" id="basic">
                    ...
                    <div class="tile p-15">
                        <form role="form" method="post">
                            <div class="form-group">
                                <input type="text" name="rif" class="form-control input-sm m-b-10" placeholder="RIF">
                            </div>
                            </br>
                            <div class="form-group">
                                <input type="text" name="nombre" class="form-control input-sm m-b-10" placeholder="Nombre">
                            </div>
                            </br>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <input type="text" name="telefono" class="form-control input-sm m-b-10" placeholder="Telefono">
                            </div>
                            </br>
                            <div class="form-group">
                                <input type="text" name="encargado" class="form-control input-sm m-b-10" placeholder="Encargado">
                            </div>
                            </br>
                            <div class="form-group">
                            ...
                            <button type="submit" name="registrarCliente" class="btn btn-sm m-t-10">Registrar</button>
                            <!--
                            <button type="submit" class="btn btn-sm m-t-10">Cancel</button>
                            -->
                        </form>
